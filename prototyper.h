...
#define APP_SOURCES "/usr/share/ru.mastercond.QmlPrototyper/qml/pages/sources/sources-QmlPrototyper-0.3.zip"
#define APP_SOURCES_OUTPUT QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation)+"/sources-QmlPrototyper-0.3.zip"
